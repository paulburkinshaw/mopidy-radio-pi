...
with con:
    ...
    with con:
		...
		cur.execute("CREATE TABLE User(Id INTEGER PRIMARY KEY, ThemeTitle TEXT, ThemeDescription TEXT, ThemeImage TEXT)")

        cur.execute("DROP TABLE IF EXISTS ThemeBanners")
		cur.execute("CREATE TABLE Tracklist(Id INTEGER PRIMARY KEY, ThemeId INT, BannerImageFileName TEXT, BannerImagePath TEXT, DateAdded DATE)")
